...
namespace Dummy.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <remarks>Mapped on  table field: "StockSector"."Code".<br/>Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 100.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <summary>The IsActive property of the Entity StockSector<br/><br/></summary>
		/// <remarks>Mapped on  table field: "StockSector"."IsActive".<br/>Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)StockSectorFieldIndex.IsActive, true); }
			set	{ SetValue((int)StockSectorFieldIndex.IsActive, value); }
		}

		/// <summary>The Name property of the Entity StockSector<br/><br/></summary>
		/// <remarks>Mapped on  table field: "StockSector"."Name".<br/>Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 500.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
