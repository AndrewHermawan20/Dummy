...
namespace Dummy.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		public DataSource2<ConfigurationEntity> Configuration {	get { return new DataSource2<ConfigurationEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<OrderHistoryEntity> OrderHistory {	get { return new DataSource2<OrderHistoryEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting OrderTypeEntity instances in the database.</summary>
		public DataSource2<OrderTypeEntity> OrderType {	get { return new DataSource2<OrderTypeEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting PortofolioEntity instances in the database.</summary>
		public DataSource2<PortofolioEntity> Portofolio {	get { return new DataSource2<PortofolioEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting PortofolioItemEntity instances in the database.</summary>
		public DataSource2<PortofolioItemEntity> PortofolioItem {	get { return new DataSource2<PortofolioItemEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		/// <summary>returns the datasource to use in a Linq query when targeting SummaryEntity instances in the database.</summary>
		public DataSource2<SummaryEntity> Summary {	get { return new DataSource2<SummaryEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		/// <summary>returns the datasource to use in a Linq query when targeting TransactionStatusEntity instances in the database.</summary>
		public DataSource2<TransactionStatusEntity> TransactionStatus {	get { return new DataSource2<TransactionStatusEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<TransactionTypeEntity> TransactionType {	get { return new DataSource2<TransactionTypeEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
